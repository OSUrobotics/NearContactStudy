function CheckerCodeGenerator(pixels)
...
%try 50 for now
% radius = 50;
radius = floor(pixels / 10);
if radius < 2
    'Radius is too small, R = ', radius
end
   ...
   for g = 0:1:numDots
       for b = 0:1:numDots
           ...
           for rr = 1:r
               ...
               x_idx = posX-radius:posX+radius;
               y_idx = posY-radius:posY+radius;
               if length(find(y_idx == 0)) == 0
